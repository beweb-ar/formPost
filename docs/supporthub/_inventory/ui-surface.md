...
| 6 | Bandeja de entrada (Inbox) | dashboard | Envíos en vivo (SSE), colapsable, badge de no leídos, estado de conexión | ninguno | admin/index.html:858-873, admin/index.html:2036 |
| 7 | Bandeja de salida (Outbox) | dashboard | Mails/notificaciones en vivo, colapsable, badge | ninguno | admin/index.html:876-890 |
| 8 | Filtro por cuenta | dashboard (solo superadmin con más de 1 cuenta) | Filtrar las tarjetas por cuenta | ninguno | admin/index.html:894-897, admin/index.html:2431 |
| 9 | Tarjetas de formularios | dashboard | Ver stats por formulario, **etiqueta del sender efectivo** (o *SIN SENDER*), desplegar detalle, abrir Envíos, Editar, Clonar, Eliminar | ninguno | admin/index.html:900-902, admin/index.html:2471 |
