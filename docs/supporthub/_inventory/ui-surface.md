...
| 9 | Tarjetas de formularios | dashboard | Ver stats por formulario, **etiqueta del sender efectivo** (o *SIN SENDER*), **indicador rojo `!` si le falta configuración**, desplegar detalle, abrir Envíos, **Salida** (bandeja de salida del form, con badge de errores), Editar, Clonar, Eliminar | ninguno | admin/index.html:900-902, admin/index.html:2471 |
